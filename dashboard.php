...
<head>
  ...
  <title>GITAM-Timetable Companion</title>
  <!-- Bootstrap core CSS-->
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <img src="images\Gandhi_Institute_of_Technology_and_Management_logo.jpg" alt="" width="35px">
    <a class="navbar-brand" href="index.html">&nbsp;GITAM UNIVERSITY HYDERABAD</a>
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Copyright © GITAM 2021</small>
        </div>
      </div>
    </footer>
